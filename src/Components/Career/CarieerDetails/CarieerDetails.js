...
const CarieerDetails = () => {
	...
	const handleApplicationForm = async (e) => {
		...
		if (result.error) {
			...
			e.target.reset();
			toast.success(
				"Job Application Successfully Submitted We'll inform you of your application status."
			);
			setProgress(false);
		}
	};
			...
			<div className="my-5">
				<Container>
					<div>
						...
						<p className=" my-0">
							<span className="fw-bold ">Job Type:</span> {job?.type}
						</p>
						<p className=" my-0">
							<span className="fw-bold ">Skills:</span> {job?.skills}
						</p>
						<p className=" mt-0">
							<span className="fw-bold">Salary Range:</span> {job?.salary_range}
						</p>
						<p className=" my-0">
							<span className="fw-bold mb-4">Job Description:</span>
						</p>
						...
						<Row className="mt-5">
							<Col md={12} sm={12}>
								<div className="bg-white  rounded ">
									<h3 className=" px-3 fw-bold text-center mb-3">
										Application Form
									</h3>
									...
									>
										...
										<div className="col-12 ">
											...
											/>
											<p>
												<small>* Please add Doc Or Pdf file only.</small>
											</p>
										</div>

        ...
        <div className='my-5'>
            <Container>
                <div>
                    ...
                    <p className=' my-0'><span className='fw-bold'>Salary Range:</span> {job?.salary_range}</p>
                    <p className=' my-0'><span className='fw-bold'>Job Description:</span> {job?.description}</p>
                </div>
